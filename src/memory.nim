...
proc read_int16(self: Process, address: ByteAddress): int16 {.exportpy.} = self.read(address, int16)
proc read_ints16(self: Process, address: ByteAddress, size: int32): seq[int16] {.exportpy.} = self.readSeq(address, size, int16)
